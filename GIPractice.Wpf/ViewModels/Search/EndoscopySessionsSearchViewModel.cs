...
public sealed class EndoscopySessionsSearchViewModel : ViewModelBase
{
    ...
    public EndoscopySessionsSearchViewModel()
    {
    ...
    private void Search()
    {
        // TODO: call EndoscopySessionsModule.SearchAsync(...)
        Items.Clear();
    }
