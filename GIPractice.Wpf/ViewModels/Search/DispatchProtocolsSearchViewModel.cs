...
public sealed class DispatchProtocolsSearchViewModel : ViewModelBase
{
    ...
    public DispatchProtocolsSearchViewModel()
    {
    ...
    private void Search()
    {
        // TODO: call DispatchProtocolsModule.SearchAsync(...)
        Items.Clear();
    }
