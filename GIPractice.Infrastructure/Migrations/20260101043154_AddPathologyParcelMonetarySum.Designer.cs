...
namespace GIPractice.Infrastructure.Migrations
{
    ...
    [Migration("20260101043154_AddPathologyParcelMonetarySum")]
    partial class AddPathologyParcelMonetarySum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GIPractice.Core.Entities.Pathologist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PricingPlanJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GIPractice.Core.Entities.PathologyParcel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MonetarySum")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<int>("PathologistId")
                        .HasColumnType("int");

                    b.Property<int?>("PathologistId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PathologistId1");

                    b.HasIndex("PathologistId", "ParcelCode")
                        .IsUnique();

                    b.ToTable("PathologyParcels", (string)null);
                });

            modelBuilder.Entity("GIPractice.Core.Entities.PathologyReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MacroscopyText")
                        .HasMaxLength(8000)
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("PathologyParcelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PathologyParcelId");

                    b.HasIndex("PatientId");

                    b.HasIndex("PathologistId", "EndoscopyId")
                        .IsUnique();
            ...
            modelBuilder.Entity("GIPractice.Core.Entities.PathologyParcel", b =>
                {
                    b.HasOne("GIPractice.Core.Entities.Pathologist", "Pathologist")
                        .WithMany()
                        .HasForeignKey("PathologistId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GIPractice.Core.Entities.Pathologist", null)
                        .WithMany("Parcels")
                        .HasForeignKey("PathologistId1");
            ...
            modelBuilder.Entity("GIPractice.Core.Entities.PathologyReport", b =>
                {
                    b.HasOne("GIPractice.Core.Entities.MediaFile", "DocumentFile")
                        .WithMany()
                    ...
                    b.HasOne("GIPractice.Core.Entities.PathologyParcel", "Parcel")
                        .WithMany("Reports")
                        .HasForeignKey("PathologyParcelId")
                        .OnDelete(DeleteBehavior.SetNull);
